...
//  Rodana
//
//  Created by Naveed ur Rehman on 14/11/2019.
...
extension UITextField{
       ...
       func addDoneButtonOnKeyboard()
       {
           ...
           let done: UIBarButtonItem = UIBarButtonItem(title: "منجز", style: .done, target: self, action: #selector(self.doneButtonAction))
